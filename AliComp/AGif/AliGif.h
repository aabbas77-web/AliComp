...
//---------------------------------------------------------------------------
class PACKAGE TAliGif : public TGraphicControl
{
public:
        TAGif *FGif;
        TTimer *FTimer;
...
protected:
        ...
        void __fastcall  StoreCompProperty(TWriter *Writer);
        void __fastcall  DefineProperties(TFiler *Filer);
public:
        __fastcall TAliGif(TComponent* Owner);
        __fastcall ~TAliGif();
        bool Draw();
        void Stop();
        void UnLoad();
