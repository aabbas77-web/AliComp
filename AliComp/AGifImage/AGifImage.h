...
//---------------------------------------------------------------------------
class PACKAGE TAFileNameProperty : public TStringProperty
{
public:
    __fastcall TAFileNameProperty(const _di_IFormDesigner ADesigner, int APropCount)
                                    :TStringProperty(ADesigner,APropCount){};
    __fastcall ~TAFileNameProperty(){};
...
//---------------------------------------------------------------------------
class PACKAGE TAGIFImage : public TGraphicControl
{
private:
        ...
        void __fastcall SetBkColor(TColor Value);
protected:
        SIZE m_PictureSize;
...
public:
        __fastcall TAGIFImage(TComponent* Owner);
        __fastcall ~TAGIFImage();
...
__published:
        ...
        __property bool Animate={read=FAnimate,write=SetAnimate};
        __property TColor BkColor={read=FBkColor,write=SetBkColor};
};
//---------------------------------------------------------------------------
#endif
