...
//---------------------------------------------------------------------------
static inline void ValidCtrCheck(TAGIFImage *)
{
        new TAGIFImage(NULL);
}
//---------------------------------------------------------------------------
__fastcall TAGIFImage::TAGIFImage(TComponent* Owner)
...
//---------------------------------------------------------------------------
__fastcall TAGIFImage::~TAGIFImage()
{
	UnLoad();
	CloseHandle(m_hExitEvent);
}
//---------------------------------------------------------------------------
void __fastcall TAGIFImage::Paint()
{
 if(GetFrameCount()<0)
  {
   Width=64;
...
namespace Agifimage
{
        ...
        {
                 TComponentClass classes[1] = {__classid(TAGIFImage)};
                 RegisterComponents("AliSoft", classes, 0);
//                 RegisterPropertyEditor(AnsiStringTypeInfo(),__classid(TAGIFImage),"FileName",__classid(TFileNameProperty));

                 TPropInfo* PropInfo=::GetPropInfo(__typeinfo(TAGIFImage),"FileName");
                 RegisterPropertyEditor(*PropInfo->PropType,
                 __classid(TAGIFImage),"FileName",
                 __classid(TAFileNameProperty));
        }
}
//---------------------------------------------------------------------------
//----------------------TGIFControlExt---------------------------------------
...
//---------------------------------------------------------------------------
BOOL TAGIFImage::Load(HGLOBAL hGlobal, DWORD dwSize)
{
...
//---------------------------------------------------------------------------
void TAGIFImage::ResetDataPointer()
{
...
//---------------------------------------------------------------------------
BOOL TAGIFImage::SkipNextGraphicBlock()
{
...
//---------------------------------------------------------------------------
UINT TAGIFImage::GetSubBlocksLen(UINT nStartingOffset) const
{
	UINT nRet = 0;
...
//---------------------------------------------------------------------------
enum GIFBlockTypes TAGIFImage::GetNextBlock() const
{
...
//---------------------------------------------------------------------------
int TAGIFImage::GetNextBlockLen() const
{
...
//---------------------------------------------------------------------------
HGLOBAL TAGIFImage::GetNextGraphicBlock(UINT *pBlockLen,
...
//---------------------------------------------------------------------------
BOOL TAGIFImage::PrepareDC(int nWidth, int nHeight)
{
	SetWindowPos(NULL,NULL,0,0,nWidth,nHeight,SWP_NOMOVE | SWP_NOZORDER);

//	HDC hWinDC = ::GetDC(Handle);
...
//---------------------------------------------------------------------------
BOOL TAGIFImage::IsGIF() const
{
	return m_bIsGIF;
}
//---------------------------------------------------------------------------
BOOL TAGIFImage::IsAnimatedGIF() const
{
	return (m_bIsGIF && (m_arrFrames.size() > 1));
}
//---------------------------------------------------------------------------
int TAGIFImage::GetFrameCount() const
{
	if (!IsAnimatedGIF())
		return 0;
...
//---------------------------------------------------------------------------
COLORREF TAGIFImage::GetBkColor() const
{
	return m_clrBackground;
}
//---------------------------------------------------------------------------
void TAGIFImage::SetBkColor(COLORREF clr)
{
...
//---------------------------------------------------------------------------
SIZE TAGIFImage::GetSize() const
{
	return m_PictureSize;
}
//---------------------------------------------------------------------------
BOOL TAGIFImage::Load(LPCTSTR szFileName)
{
	ASSERT(szFileName);
...
//---------------------------------------------------------------------------
BOOL TAGIFImage::Load(LPCTSTR szResourceName, LPCTSTR szResourceType)
{
...
//---------------------------------------------------------------------------
UINT WINAPI TAGIFImage::_ThreadAnimation(LPVOID pParam)
{
	ASSERT(pParam);
	TAGIFImage *pPic = reinterpret_cast<TAGIFImage *> (pParam);
...
//---------------------------------------------------------------------------
void TAGIFImage::ThreadAnimation()
{
...
//---------------------------------------------------------------------------
void __fastcall TAGIFImage::SetFileName(AnsiString Value)
{
 FFileName=Value;
 Load(FFileName.c_str());
 Draw();
 FAnimate=true;
}
//---------------------------------------------------------------------------
void __fastcall TAGIFImage::SetAnimate(bool Value)
{
 FAnimate=Value;
 if(FAnimate)
  Draw();
...
//---------------------------------------------------------------------------
void __fastcall TAGIFImage::SetBkColor(TColor Value)
{
 FBkColor=Value;
// SetBkColor(FBkColor);
 Invalidate();
...
//-------------------TFileName-----------------------------------------------
//---------------------------------------------------------------------------
void __fastcall TAFileNameProperty::Edit()
{
...
//---------------------------------------------------------------------------
TPropertyAttributes __fastcall TAFileNameProperty::GetAttributes()
{
